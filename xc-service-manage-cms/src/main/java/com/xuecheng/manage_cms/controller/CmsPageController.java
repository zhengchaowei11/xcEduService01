...
public class CmsPageController implements CmsPageControllerApi {
    ...
    public QueryResponseResult findList(@PathVariable("page") int page,@PathVariable("size") int size, QueyPageRequest queyPageRequest) {
       /* QueryResult<CmsPage> queryResult = new QueryResult<>();
        //其中的QueryResult
        CmsPage cmsPage = new CmsPage();
        cmsPage.setPageName("文字信息");
...
*/
        ...
        return pageService.findList(page,size,queyPageRequest);
    }
    ...
    public CmsPage findById(@PathVariable String id) {
        return pageService.getId(id);
    }

    @Override
    @PutMapping("/edit/{id}") //put表示更新方法的意思
